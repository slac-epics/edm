...
static char *dragName[] = {
  activeSlacBarClass_str1,
  activeSlacBarClass_str2,
};
...
class activeSlacBarClass : public activeGraphicClass {
...
void *clone_activeSlacBarClassPtr ( void * );
